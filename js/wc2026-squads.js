...
window.WC_SQUADS = {
  ...
  'JPN': {
    ...
    players: [
      ...
      { name: 'Takehiro Tomiyasu',nameCN: '冨安健洋', pos: 'DEF', club: '阿賈克斯',                    age: 27 },
      ...
      // 前鋒
      { name: 'Junya Ito',        nameCN: '伊東純也', pos: 'FWD', club: '根特',                      age: 32 },
      ...
      { name: 'Kento Shiogai',    nameCN: '塩貝健人', pos: 'FWD', club: '沃夫斯堡',                  age: 23 },
      { name: 'Keisuke Goto',     nameCN: '後藤啓介', pos: 'FWD', club: '聖圖伊登',                  age: 21 },
    ],
  },
  ...
  'FRA': {
    ...
    players: [
      ...
      { name: 'Robin Risser',       nameCN: '里塞',          pos: 'GK',  club: '朗斯',              age: 22 },
      // 後衛
      ...
      { name: 'Theo Hernández',     nameCN: '特奧·埃爾南德斯', pos: 'DEF', club: '利雅德新月',      age: 28 },
  ...
  'KOR': {
    ...
    players: [
      ...
      { name: 'Kim Seung-gyu',   nameCN: '金承奎',   pos: 'GK',  club: 'FC 東京',       age: 35 },
      { name: 'Song Bum-keun',   nameCN: '宋範根',   pos: 'GK',  club: '全北現代',      age: 28 },
      // 後衛
      { name: 'Kim Min-jae',     nameCN: '金玟哉',   pos: 'DEF', club: '拜仁慕尼黑',    age: 29 },
      { name: 'Cho Yu-min',      nameCN: '趙裕民',   pos: 'DEF', club: '沙迦',          age: 30 },
      { name: 'Lee Han-beom',    nameCN: '李韓凡',   pos: 'DEF', club: '密德蒂蘭',      age: 23 },
      { name: 'Kim Tae-hyeon',   nameCN: '金泰賢',   pos: 'DEF', club: 'FC 首爾',       age: 25 },
      { name: 'Park Jin-seob',   nameCN: '朴鎮燮',   pos: 'DEF', club: '浙江 FC',       age: 30 },
      { name: 'Lee Gi-hyuk',     nameCN: '李奇赫',   pos: 'DEF', club: '抱川市民',      age: 25 },
      { name: 'Lee Tae-seok',    nameCN: '李泰錫',   pos: 'DEF', club: '奧地利維也納',  age: 24 },
      { name: 'Seol Young-woo',  nameCN: '薛永祐',   pos: 'DEF', club: '紅星貝爾格萊德',age: 26 },
      ...
      { name: 'Eom Ji-sung',     nameCN: '嚴志成',   pos: 'MID', club: '斯旺西',        age: 22 },
  ...
  'BIH': {
    ...
    note: '40 歲 Edin Džeko 領銜（黃金世代最後一人、Pjanić 已退役）；首支公布最終 26 的隊伍',
    players: [
      // 守門員
      { name: 'Nikola Vasilj',          nameCN: '瓦西利',           pos: 'GK',  club: '聖保利',           age: 29 },
      { name: 'Martin Zlomislić',       nameCN: '茲洛米斯利奇',     pos: 'GK',  club: '里耶卡',           age: 27 },
      { name: 'Osman Hadžikić',         nameCN: '哈濟基奇',         pos: 'GK',  club: '',                 age: 29 },
      // 後衛
      { name: 'Sead Kolašinac',         nameCN: '柯拉辛納茨',       pos: 'DEF', club: '亞特蘭大',         age: 32 },
      { name: 'Amar Dedić',             nameCN: '德迪奇',           pos: 'DEF', club: '本菲卡',           age: 22 },
      { name: 'Nihad Mujakić',          nameCN: '穆亞基奇',         pos: 'DEF', club: '加濟安泰普',       age: 27 },
      { name: 'Nikola Katić',           nameCN: '卡蒂奇',           pos: 'DEF', club: '沙爾克 04',        age: 28 },
      { name: 'Tarik Muharemović',      nameCN: '穆哈雷莫維奇',     pos: 'DEF', club: '薩索羅',           age: 23 },
      { name: 'Stjepan Radeljić',       nameCN: '拉德利奇',         pos: 'DEF', club: '里耶卡',           age: 25 },
      { name: 'Dennis Hadžikadunić',    nameCN: '哈濟卡杜尼奇',     pos: 'DEF', club: '森多利亞',         age: 25 },
      { name: 'Nidal Čelik',            nameCN: '切里克',           pos: 'DEF', club: '朗斯',             age: 22 },
      // 中場
      { name: 'Amir Hadžiahmetović',    nameCN: '哈濟亞梅托維奇',   pos: 'MID', club: '赫爾城',           age: 26 },
      { name: 'Ivan Šunjić',            nameCN: '蘇尼奇',           pos: 'MID', club: 'Pafos',            age: 30 },
      { name: 'Ivan Bašić',             nameCN: '巴西奇',           pos: 'MID', club: '阿斯塔納',         age: 26 },
      { name: 'Dženis Burnić',          nameCN: '布爾尼奇',         pos: 'MID', club: '卡爾斯魯爾',       age: 26 },
      { name: 'Benjamin Tahirović',     nameCN: '塔希羅維奇',       pos: 'MID', club: '布隆德比',         age: 22 },
      { name: 'Armin Gigović',          nameCN: '吉戈維奇',         pos: 'MID', club: '伯爾尼年輕人',     age: 22 },
      { name: 'Ermin Mahmić',           nameCN: '馬赫米奇',         pos: 'MID', club: '利貝雷茨',         age: 24 },
      { name: 'Amar Memić',             nameCN: '梅米奇',           pos: 'MID', club: '皮爾森勝利',       age: 23 },
      // 前鋒
      { name: 'Edin Džeko',             nameCN: '哲科',             pos: 'FWD', club: '沙爾克 04',        age: 40, note: '隊長 / 黃金世代' },
      { name: 'Esmir Bajraktarević',    nameCN: '巴伊拉克塔雷維奇', pos: 'FWD', club: 'PSV',              age: 21, note: '附加賽英雄' },
      { name: 'Ermedin Demirović',      nameCN: '德米羅維奇',       pos: 'FWD', club: '斯圖加特',         age: 27 },
      { name: 'Haris Tabaković',        nameCN: '塔巴科維奇',       pos: 'FWD', club: '門興格拉德巴赫',   age: 31 },
      { name: 'Kerim Alajbegović',      nameCN: '阿萊貝戈維奇',     pos: 'FWD', club: 'RB 薩爾斯堡',      age: 22 },
      { name: 'Samed Baždar',           nameCN: '巴茲達爾',         pos: 'FWD', club: '比亞韋斯托克',     age: 24 },
    ],
  },
  ...
  'CIV': {
    status: 'final',
    announcedAt: '2026-05-15',
    note: 'Franck Kessié 隊長（破百出場）；Amad Diallo 首屆世界盃；2014 後首度晉級',
    players: [
      // 守門員
      { name: 'Yahia Fofana',     nameCN: '法芬納',        pos: 'GK',  club: '里澤體育',       age: 33 },
      { name: 'Mohamed Koné',     nameCN: '科內',          pos: 'GK',  club: '查爾洛瓦',       age: 22 },
      { name: 'Alban Lafont',     nameCN: '拉豐',          pos: 'GK',  club: '帕納辛奈科斯',   age: 28 },
      // 後衛
      { name: 'Evan Ndicka',      nameCN: '恩迪卡',        pos: 'DEF', club: '羅馬',           age: 26 },
      { name: 'Wilfried Singo',   nameCN: '辛戈',          pos: 'DEF', club: '加拉塔薩雷',     age: 25 },
      { name: 'Emmanuel Agbadou', nameCN: '阿巴多',        pos: 'DEF', club: '貝西克塔斯',     age: 27 },
      { name: 'Clément Akpa',     nameCN: '阿克帕',        pos: 'DEF', club: '歐塞爾',         age: 23 },
      { name: 'Ousmane Diomandé', nameCN: '迪奧曼德',      pos: 'DEF', club: '葡萄牙體育',     age: 23 },
      { name: 'Guéla Doué',       nameCN: '杜埃',          pos: 'DEF', club: '史特拉斯堡',     age: 20 },
      { name: 'Ghislain Konan',   nameCN: '科南',          pos: 'DEF', club: '吉爾維森特',     age: 30 },
      { name: 'Odilon Kossounou', nameCN: '科蘇努',        pos: 'DEF', club: '亞特蘭大',       age: 24 },
      // 中場
      { name: 'Franck Kessié',    nameCN: '凱西耶',        pos: 'MID', club: '阿哈利',         age: 29, note: '隊長' },
      { name: 'Seko Fofana',      nameCN: '佛法納',        pos: 'MID', club: '波圖',           age: 30 },
      { name: 'Parfait Guiagon',  nameCN: '吉亞貢',        pos: 'MID', club: '查爾洛瓦',       age: 25 },
      { name: 'Christ Inao Oulaï',nameCN: '烏萊',          pos: 'MID', club: '特拉布宗',       age: 24 },
      { name: 'Ibrahim Sangaré',  nameCN: '桑加雷',        pos: 'MID', club: '諾丁漢森林',     age: 27 },
      { name: 'Jean-Michaël Seri',nameCN: '塞里',          pos: 'MID', club: 'NK 馬里博爾',    age: 34 },
      // 前鋒
      { name: 'Nicolas Pépé',     nameCN: '佩佩',          pos: 'FWD', club: '比利亞雷亞爾',   age: 30 },
      { name: 'Amad Diallo',      nameCN: '迪亞洛',        pos: 'FWD', club: '曼聯',           age: 23, note: '首屆世界盃' },
      { name: 'Evann Guessand',   nameCN: '蓋桑',          pos: 'FWD', club: '水晶宮',         age: 24, note: '首屆世界盃' },
      { name: 'Simon Adingra',    nameCN: '阿丁格拉',      pos: 'FWD', club: '摩納哥',         age: 24 },
      { name: 'Ange-Yoan Bonny',  nameCN: '邦尼',          pos: 'FWD', club: '國際米蘭',       age: 22, note: '剛轉籍' },
      { name: 'Oumar Diakité',    nameCN: '迪亞基特',      pos: 'FWD', club: '塞克爾克布魯日', age: 24 },
      { name: 'Yan Diomandé',     nameCN: '迪奧曼德',      pos: 'FWD', club: 'RB 萊比錫',      age: 21 },
      { name: 'Bazoumana Touré',  nameCN: '圖雷',          pos: 'FWD', club: '霍芬海姆',       age: 22 },
      { name: 'Elye Wahi',        nameCN: '瓦希',          pos: 'FWD', club: '尼斯',           age: 22 },
    ],
  },
  ...
  'TUN': {
    status: 'final',
    announcedAt: '2026-05-15',
    note: 'Ellyes Skhiri 隊長；Lamouchi 1 月接手 Trabelsi；Khedira 兄是 2014 德國冠軍成員',
    players: [
      // 守門員
      { name: 'Aymen Dahmen',         nameCN: '達赫曼',        pos: 'GK',  club: 'CS 法克斯',       age: 28 },
      ...
      { name: 'Adem Arous',           nameCN: '阿魯斯',        pos: 'DEF', club: '卡塞姆帕薩',       age: 24 },
      { name: 'Raed Chikhaoui',       nameCN: '齊豪維',        pos: 'DEF', club: 'US 莫納斯提爾',    age: 29 },
      { name: 'Moutaz Neffati',       nameCN: '內法蒂',        pos: 'DEF', club: 'IFK 諾克平',       age: 25 },
      { name: 'Mohamed Ali Ben Hmida',nameCN: '本希米達',      pos: 'DEF', club: '突尼西亞希望',     age: 27 },
      // 中場
      { name: 'Ellyes Skhiri',        nameCN: '斯基里',        pos: 'MID', club: '法蘭克福',         age: 31, note: '隊長' },
      { name: 'Rani Khedira',         nameCN: '凱迪拉',        pos: 'MID', club: '聯合柏林',         age: 32 },
      { name: 'Hannibal Mejbri',      nameCN: '梅伊布里',      pos: 'MID', club: '伯恩利',           age: 23 },
      { name: 'Anis Ben Slimane',     nameCN: '本斯利曼',      pos: 'MID', club: '諾威治',           age: 23 },
      { name: 'Mortadha Ben Ouanes',  nameCN: '本瓦尼斯',      pos: 'MID', club: '卡塞姆帕薩',       age: 24 },
      { name: 'Ismaël Gharbi',        nameCN: '加爾比',        pos: 'MID', club: '奧格斯堡',         age: 20 },
      { name: 'Mohamed Hadj Mahmoud', nameCN: '哈吉馬穆德',    pos: 'MID', club: '盧加諾',           age: 24 },
      // 前鋒
      { name: 'Khalil Ayari',         nameCN: '阿亞里',        pos: 'FWD', club: 'PSG',              age: 21 },
      { name: 'Sebastian Tounekti',   nameCN: '圖內克提',      pos: 'FWD', club: '塞爾提克',         age: 22 },
      { name: 'Elias Achouri',        nameCN: '阿丘里',        pos: 'FWD', club: 'FC 哥本哈根',      age: 21 },
      { name: 'Firas Chaouat',        nameCN: '夏瓦特',        pos: 'FWD', club: '非洲俱樂部',       age: 27 },
      { name: 'Hazem Mastouri',       nameCN: '馬斯圖里',      pos: 'FWD', club: '馬哈奇卡拉迪納摩', age: 29 },
      { name: 'Elias Saad',           nameCN: '薩阿德',        pos: 'FWD', club: '漢諾威 96',        age: 25 },
      { name: 'Rayen Elloumi',        nameCN: '埃盧米',        pos: 'FWD', club: '溫哥華白浪',       age: 19 },
    ],
  },
  ...
  'HAI': {
    status: 'final',
    announcedAt: '2026-05-14',
    note: 'Placide 隊長；以歐美僑民球員為主、平均年齡 24 歲、史上第 2 度世界盃；部分隊員資料待補',
    players: [
      // 守門員
      ...
      { name: 'Woodensky Pierre', nameCN: '皮埃爾',        pos: 'MID', club: '紫羅蘭體育',     age: 25, note: '唯一海地本土聯賽球員' },
      { name: 'Don Deedson Louicius', nameCN: '魯西厄斯',  pos: 'MID', club: 'FC 達拉斯',      age: 24 },
      // 前鋒
