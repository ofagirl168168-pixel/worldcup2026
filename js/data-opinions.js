...
const DAILY_OPINIONS = [
  ...
  { id:'op-20260505-a', date:'2026-05-05', type:'predict',
    ...
    context:"歐冠半決賽次回合：兵工廠 vs 馬競（5/5 03:00 台灣時間，Emirates Stadium）。首回合馬德里 1-1 平手。兵工廠本季歐冠主場全勝，且聯賽階段曾 4-0 大勝馬競。Gyökeres 在對富勒姆梅開二度狀態火燙。馬競客場歐冠 W2 D1 L1，Simeone 的球隊以堅韌防守著稱。Arteta 距首座歐冠獎杯僅差兩場。" },

  { id:'op-20260504-a', date:'2026-05-04', type:'predict',
    q:"英超第 35 輪：切爾西 vs 諾丁漢森林，藍軍能止住頹勢嗎？",
    opts:["切爾西主場復甦，2-0 或以上大勝 🔵","諾丁漢森林客場搶分，1-1 悶平 🌳","森林爆冷贏球！切爾西本季主場第 N 次翻車 😱","進球大戰，雙方各有破門 🔥"],
