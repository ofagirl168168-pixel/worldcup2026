...
const DAILY_OPINIONS = [
  ...
  { id:'op-20260506-a', date:'2026-05-06', type:'predict',
    ...
    opts:["拜仁安聯魔咒護身，主場逆轉晉級 🔴","PSG Donnarumma 神撲守住，1-1 晉級 🛡️","進球大戰再現，總比分 PSG 客場進球險勝 ⚽","Hakimi 缺陣 PSG 後防崩盤，拜仁 3-0 強勢晉級 💥"],
    context:"歐冠半決賽次回合：拜仁慕尼黑 vs 巴黎聖日耳曼（5/7 03:00 台灣時間，安聯球場）。首回合 PSG 主場 5-4 險勝。拜仁安聯本季歐冠 6 戰全勝、近 29 場主場僅輸 1。PSG 傷兵：Hakimi 大腿傷確定缺席次回合，後防右翼將靠替補。拜仁 vs PSG 是史上首次「兩隊單季都進球破 40」的歐冠對決（PSG 43 球、拜仁 42 球）。Kompany 帶領拜仁渴望首座歐冠獎杯。" },
