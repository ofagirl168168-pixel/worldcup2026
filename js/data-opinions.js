...
const DAILY_OPINIONS = [
  ...
  { id:'op-20260428-a', date:'2026-04-28', type:'trending',
    q:"歐冠四強首回合：巴黎主場迎拜仁，誰能搶得先機？",
    opts:["巴黎主場穩拿，淘汰賽零封紀錄延續 🏟️","拜仁客場爆發，Kane 領軍攻破巴黎 ⚡","0-0 或 1-1 悶平，決戰留到次回合 🤝","巴黎小勝但拜仁拿到客場進球 🔑"],
    context:"4/29（三）03:00 台灣時間，歐冠半決賽首回合在王子公園球場開踢。巴黎本季淘汰賽四場僅失2球，八強兩回合4-0碾壓利物浦；拜仁則是全歐最恐怖攻擊（場均3.6球），八強6-4淘汰皇馬。Dembélé（金球獎得主）vs Kane（本季53球）的對決萬眾矚目。歷史上兩隊16次交手拜仁9勝，近6次贏5場。" },
  ...
  { id:'op-20260426-c', date:'2026-04-26', type:'trending',
    ...
    context:"乙爾西翼鋒 Estevao 對曼聯被迫退場，報導指可能是罕見的「Grade 4」腿後肌拉傷，或需手術、缺席數月。年僅 19 歲的他是巴西世界盃陣容重要棋子。" },
