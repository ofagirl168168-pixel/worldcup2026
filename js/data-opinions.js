...
const DAILY_OPINIONS = [
  ...
  { id:'op-20260420-a', date:'2026-04-20', type:'trending',
    q:"曼城 vs 兵工廠激戰後，英超冠軍還有懸念嗎？",
    opts:["沒了，兵工廠穩奪冠 🔴","有，曼城還會翻盤 🔵","利物浦偷笑，反超有望 ❤️"],
    context:"Matchday 33 Etihad 強碰，賽前兵工廠 70 分領先曼城 6 分（第 5 輪剩）；兩隊傷兵名單都長" },
  ...
  { id:'op-20260422', date:'2026-04-22', type:'classic',
    q:'梅西 vs C羅，不用解釋，選一個',
    opts:['梅西 🐐','C羅 🐐'],
    context:'足球史上最偉大的辯論，沒有正確答案' },

  { id:'op-20260423', date:'2026-04-23', type:'fun',
    q:'凌晨3點的世界盃比賽，你會爬起來看嗎？',
    opts:['一定看，睡什麼睡 🌙','不會，隔天還要上班 😴'],
    context:'2026世界盃在美加墨舉辦，台灣時差讓很多比賽在凌晨' },
