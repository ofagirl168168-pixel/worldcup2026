...
const DAILY_OPINIONS = [
  ...
  { id:'op-20260511-a', dates:['2026-05-11','2026-05-12'], type:'trending',
  ...
  { id:'op-20260512-a', date:'2026-05-12', type:'predict',
    q:"🔮 英超保級倒數：西漢姆 vs 熱刺只剩一隊能活，你覺得誰會降級？",
    opts:["西漢姆降級！Nuno 的球隊進攻太弱，剩餘賽程也更難 🔨⬇️","熱刺降級！De Zerbi 救不了這支傷兵滿營的球隊 🐓⬇️","兩隊都不降！最後兩輪會有其他球隊翻船 🎲","兩隊一起降！森林或里茲意外安全，雙雙墜落 💀"],
    context:"英超保級白熱化：伯恩利、狼隊已確定降級，第三個降級名額在西漢姆（第18名）和熱刺（第17名）之間決定。兩隊僅差1分。西漢姆剩餘賽程：紐卡索（客）、里茲（主）。熱刺剩餘賽程：切爾西（客，5/19）、艾佛頓（主，5/24）。里茲和森林已數學上安全。5/10 西漢姆 0-1 輸兵工廠，保級形勢更加嚴峻。" },
