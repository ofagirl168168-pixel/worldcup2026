...
const DAILY_OPINIONS = [
  ...
  { id:'op-20260516-b', date:'2026-05-16', type:'trending',
    q:"🔥 Messi 入選阿根廷 55 人初選名單！38 歲的他該去世界盃嗎？",
    opts:["必須去！Messi 是足球之神，最後一屆世界盃不去是全人類的損失 🐐","不該去！38 歲體能堪憂，不要毀掉 2022 年完美的謝幕 ❌","去但當替補！精神領袖 + 關鍵時刻上場就好，不用先發 🪄","看身體狀況！如果 MLS 賽季末狀態好就去，勉強上場反而拖累球隊 🤔"],
    context:"阿根廷主帥 Scaloni 在 5/11 公布 55 人初選名單，38 歲的 Messi 在列。Messi 去年十月表示「如果覺得身體狀態夠好就會去」，但尚未正式確認出戰。最終 26 人名單需在 5/30 提交、FIFA 6/2 確認。Di María 不在名單中。這可能是 Messi 的最後一屆世界盃——2022 年在卡達捧盃的畫面仍歷歷在目。" },

  { id:'op-20260514-b', date:'', type:'trending',
    q:"🏆 FA Cup 決賽週六開踢！曼城 vs 切爾西，誰能打破魔咒？",
    opts:["曼城！Guardiola 說「生死戰」不是開玩笑，Haaland + Foden 狀態正好 🩵","切爾西！藍軍 6 連敗domestic cup final 的恥辱必須終結，Wembley 翻身 🔵","曼城穩贏但會很辛苦，體能是隱憂——三天前才踢補賽 😰","兩隊都被魔咒纏身，PK 大戰收場的可能性最高 🎲"],
    context:"5/16（六）15:00 BST（22:00 台灣時間），FA Cup 決賽在 Wembley 開踢。曼城連續 4 年闖進 FA Cup 決賽（英格蘭史上首隊），但近 2 年都在決賽輸球（2024 輸曼聯、2025 輸水晶宮）。切爾西本季聯賽低迷，但 FA Cup 一路過關斬將；然而切爾西已連續輸掉 6 場國內盃賽決賽（含 3 場 FA Cup + 3 場聯賽盃）。Guardiola 賽前稱「這是生死戰」。曼城三天前才踢完補賽 3-0 贏水晶宮，體能管理是關鍵。" },

  { id:'op-20260515-b', date:'2026-05-15', type:'trending',
    q:"🔥 Foden 兩助攻達英超百次貢獻！他值得曼城開新約嗎？",
    opts:["必須續約！Foden 健康時就是英超最強創造者，皇冠上的寶石 👑","不該續約！傷病太多太不穩定，曼城應該趁高價賣掉 💰","續但降薪！Foden 有天賦但出勤率太差，薪資要反映上場時間 📉","看世界盃表現再決定！如果世界盃大放異彩就續，打鐵就賣 🏆"],
    context:"Phil Foden 在曼城 3-0 水晶宮補賽中兩次助攻（Semenyo 32' + Marmoush 40'），達成英超第 100 次直接進球貢獻。這是他兩個多月來首次英超先發。過去兩季他飽受傷病困擾，出勤率大幅下降，但天賦毋庸置疑。曼城據報已準備好新合約。" },
  ...
  { id:'op-20260514-a', date:'2026-05-14', type:'trending',
    ...
    context:"5/13 曼城主場補賽 vs 水晶宮。兵工廠 79 分（剩 2 場：伯恩利主、最後一輪），曼城補賽前 74 分（剩 3 場）。曼城贏球追到差 2 分，平或敗則兵工廠幾乎鎖定冠軍。Haaland 狀態火熱，Rodri 傷癒中。兵工廠 MW37 主場迎戰已降級的伯恩利，理論上三分到手。" },
