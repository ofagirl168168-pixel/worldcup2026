...
const DAILY_OPINIONS = [
  ...
  { id:'op-20260519-a', date:'2026-05-19', type:'predict',
    q:"🔮 今晚兵工廠 vs 伯恩利！Arteta 能在主場封王嗎？",
    opts:["兵工廠大勝封王！3-0 以上碾壓已降級的伯恩利，酋長球場狂歡 🏆","兵工廠小勝！1-0 或 2-1 緊張拿下，等曼城結果才知能否封王 😅","爆冷平局！降級隊拚最後尊嚴，兵工廠封王要再等 😱","伯恩利逆天爆冷贏球！降級隊的告別演出成歷史經典 🔥"],
    context:"5/19（一）03:00 台灣時間，酋長球場。兵工廠（第1・79分）主場迎戰已降級伯恩利（第19・21分）。兵工廠贏球若曼城明晚不勝伯恩茅斯，即確定封王——時隔 22 年再奪英超冠軍。Opta 給兵工廠 86.9% 勝率。伯恩利本季聯賽僅 4 勝，但降級隊最後幾場常有拚勁。Ben White 賽季報銷，Timber 腹股溝存疑。" },

  { id:'op-20260518-c', date:'2026-05-18', type:'trending',
    q:"🎤 世界盃決賽中場秀 Madonna + Shakira + BTS！足球賽該這樣搞嗎？",
    opts:["太讚了！世界盃本來就該是全球盛事，中場秀讓更多人關注 🎉","反對！這是足球不是超級盃，15 分鐘中場休息不該被延長 ⚽","可以接受但別延長比賽！如果不影響球員休息就 OK 🤷","FIFA 只想賺錢！把足球最神聖的決賽變成商業表演太噁心了 💰"],
    context:"FIFA 宣布 2026 世界盃決賽（7/19 MetLife Stadium）將首次加入中場表演秀，由 Madonna、Shakira 和 BTS 聯合演出。球員工會和歐洲傳統球迷團體強烈反對，認為這是「足球美式化」。支持者認為能吸引更多觀眾、提升全球影響力。歐洲多家球迷組織已發表公開信要求 FIFA 撤回決定。" },

  { id:'op-20260516-c', date:'', type:'trending',
    q:"💥 Villa 4-2 大勝 Liverpool！利物浦歐冠資格告急，Slot 的帥位還保得住嗎？",
    opts:["該換！衛冕冠軍淪落到前四都保不住，51 個丟球英超最慘，Slot 戰術已被破解 🚪","再給一季！傷兵太多不能全怪教練，Liverpool 需要穩定而不是再換人 🛡️","問題出在球員！Carragher 說得對，Liverpool 太多弱者，換教練也沒用 😤","最後一輪定生死！現在討論太早，如果最終拿到前四就沒事 ⏳"],
    context:"Villa 4-2 Liverpool（5/16 凌晨），Watkins 梅開二度 + Rogers、McGinn 各進一球，Van Dijk 兩度頭槌扳回顏面。Villa 確認下季歐冠資格，Liverpool 跌至第 5（落後 Villa 3 分），最後一輪必須贏球才有機會。Carragher 賽後砲轟「Liverpool 太多弱者、什麼都不突出」。本季 Liverpool 37 場已丟 51 球，創隊史 38 場賽季新高（首次超過 50 球）。Slot 第二季從冠軍跌至前四邊緣，壓力巨大。" },
  ...
  { id:'op-20260517-b', date:'2026-05-17', type:'trending',
    q:"🔥 Villa Park 屠殺！維拉 4-2 血洗利物浦，紅軍的歐冠夢碎了嗎？",
    opts:["碎了！利物浦末輪還得看別人臉色，而且傷兵一堆根本沒希望 💔","還有機會！末輪贏布倫特福德就有希望，Slot 會激發背水一戰 🔥","問題比歐冠更嚴重！Slot 第一季就這樣結尾，夏天大改組是必然 🔨","無所謂！利物浦有更重要的事——Salah 的續約和世界盃才是重點 😎"],
    context:"5/16 凌晨 Villa Park 慘劇：Watkins 梅開二度、Rogers + McGinn 各進一球，維拉 4-2 血洗利物浦升至第 4（62 分）。利物浦跌至第 5（59 分），落後 3 分。紅軍末輪主場對布倫特福德，必須贏球且看維拉/伯恩茅斯結果。Szoboszlai 致命滑倒送 Watkins 第二球，Slot 賽後承認球隊承受巨大壓力。Salah 僅替補上場數分鐘，Wirtz 因腸胃炎缺陣。" },
  ...
  { id:'op-20260515-c', date:'2026-05-15', type:'trending',
    q:"💔 三笘薰因傷落選日本世界盃 26 人大軍！對日本前景多大打擊？",
    opts:["💀 致命傷 — 沒三笘日本基本沒戲","⚠️ 影響大 — 但久保 + 鎌田還能撐","🤔 還好 — 替代人選夠多（堂安/中村敬斗/前田）","😎 影響不大 — 日本實力夠厚、本來就重防"],
    context:"日本主帥森保一 5/15 公布世界盃 26 人最終名單，布萊頓王牌三笘薰因 5/9 對狼隊比賽中左腿後肌腱拉傷確認落選。這份名單同時集體缺失 4 名要角：三笘（傷）+ 南野拓実（傷）+ 守田英正（傷）+ 町田浩樹（傷）。另一焦點是 39 歲長友佑都入選，成為亞洲史上首位 5 屆連續世界盃出場球員。左路替代：伊東純也、中村敬斗、堂安律、前田大然、久保建英均在列。森保一賽前表示「三笘迄今活動中是很重要的存在」。" },
