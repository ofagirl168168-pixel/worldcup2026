...
const UCL_MATCHES = [
  ...
  {id:'UCL-SF-01', date:'2026-04-29', time:'03:00', home:'PSG', away:'BAY', stage:'sf', leg:1, status:'finished', score:{h:5,a:4}, halfTime:{h:3,a:2}, stats:{poss:[42.6,57.4],shots:[12,10],sot:[5,8],corners:[3,5],yellow:[3,1],saves:[4,0]}, goals:[{min:'17',player:'Harry Kane',side:'a'},{min:'24',player:'Khvicha Kvaratskhelia',side:'h'},{min:'33',player:'João Neves',side:'h'},{min:'41',player:'Michael Olise',side:'a'},{min:'45+5',player:'Ousmane Dembélé',side:'h',type:'pen'},{min:'56',player:'Khvicha Kvaratskhelia',side:'h'},{min:'58',player:'Ousmane Dembélé',side:'h'},{min:'65',player:'Dayot Upamecano',side:'a'},{min:'68',player:'Luis Díaz',side:'a'}]},
