...
const UCL_MATCHES = [
  ...
  {id:'UCL-SF-03', date:'2026-05-06', time:'03:00', home:'ARS', away:'ATM', stage:'sf', leg:2, status:'finished', score:{h:1,a:0}, agg:{h:2,a:1}, halfTime:{h:1,a:0}, stats:{poss:[72.5,27.5],shots:[11,9],sot:[2,2],corners:[6,3],yellow:[2,3],saves:[2,1]}, goals:[{min:'44',player:'Bukayo Saka',side:'h'}]},
  {id:'UCL-SF-04', date:'2026-05-07', time:'03:00', home:'BAY', away:'PSG', stage:'sf', leg:2, status:'finished', score:{h:1,a:1}, agg:{h:5,a:6}, halfTime:{h:0,a:1}, stats:{poss:[58,42],shots:[18,15],sot:[5,3],corners:[7,3],yellow:[2,1],saves:[2,4]}, goals:[{min:'3',player:'Ousmane Dembélé',side:'a'},{min:'90+4',player:'Harry Kane',side:'h'}]},

  // ===== 決賽 (2026-05-31 03:00 台灣時間 · 布達佩斯普斯卡什球場) =====
  {id:'UCL-F-01', date:'2026-05-31', time:'03:00', home:'ARS', away:'PSG', stage:'final', venue:'Puskás Aréna, Budapest', status:'scheduled', score:null}
];
