...
<p>5/11（一）23:00 開戰，麥迪擂台會在當日凌晨開放<strong>「熱刺能不能搶下這 3 分？」</strong>預測題——投票截止前都可以加入挑戰。</p>`,
  ...
  {
    id: 'epl-049',
    title: '【賽前分析】第36輪其餘場次：森林5連勝能否延續、升班馬挑戰歐冠隊',
    date: '2026-05-08',
    category: '賽前分析',
    summary: '第36輪剩餘場次速覽：森林5連勝挑戰紐卡索、桑德蘭主場面對歐冠確認的曼聯。已降級的伯恩利和狼隊各自迎戰維拉與布萊頓。（熱刺 vs 里茲、森林 vs 紐卡索的單場深度分析另見專文）',
    content: `<h2>第36輪其餘場次速覽</h2>

<p><em>熱刺 vs 里茲聯、諾丁漢森林 vs 紐卡索的單場深度分析請見專文 epl-050、epl-051。本文整理其餘場次。</em></p>

<h3>焦點戰：諾丁漢森林 vs 紐卡索｜5/10（日）21:00 台灣時間</h3>
<p><strong>森林（第16・42分）</strong>近期各項賽事5連勝（含英超3場進12球僅失1球），包括客場 3-1 擊敗切爾西——這波連勝讓他們從降級區邊緣爬到相對安全的位置。<strong>紐卡索（第13・45分）</strong>近6場僅1勝、深陷低迷，賽季中段一度挑戰歐冠區的勢頭已經完全消失。</p>
<p>森林主場士氣正旺，紐卡索則防線失血嚴重。裁判 Paul Tierney 執法。</p>
<p><strong>預測：森林 2-0 紐卡索</strong>——狀態天壤之別，森林有望6連勝鎖定安全。</p>

<h3>焦點戰 3：桑德蘭 vs 曼聯｜5/9（六）22:00 台灣時間</h3>
