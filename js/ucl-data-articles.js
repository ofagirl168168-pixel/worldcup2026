...
- **Viktor Gyökeres** — 受傷缺陣，夏天從體育CP加盟的瑞典射手無法出戰前東家
- **Jurriën Timber** — 受傷缺陣
- **Mikel Merino** — 受傷缺陣
...
- **Nuno Santos** — 長期傷缺
- 夏天失去 Gyökeres（轉會至兵工廠）後進攻火力大減，Conrad Harder 扛起鋒線重擔

**翻盤條件：** 體育CP 只需在客場進1球就能將比賽拖入延長賽。如果能在90分鐘內以 2-0 以上獲勝就能直接晉級。但缺少 Gyökeres 和 Hjulmand 的體育CP，攻防兩端都元氣大傷。
...
### Arteta 的挑戰
兵工廠週六才輸了球，士氣是個問題。但歐冠淘汰賽完全是另一回事——酋長球場的歐冠之夜，球迷的力量會是最大的第12人。1-0 的領先雖然微弱，但兵工廠的防守能力（Saliba + Gabriel）是全歐洲最頂級的。Gyökeres 雖因傷缺陣無法上場，但這支兵工廠的整體實力依然不容小覷。
...
**信心指數：78%**`,
    tags: ['八強', '兵工廠', '體育CP', '次回合', 'Gyökeres', 'Saka傷缺']
  },
  {
    id: 'ucl-010',
...
- 2021/22 對巴黎、乙爾西、曼城的連續翻盤仍讓人記憶猶新
